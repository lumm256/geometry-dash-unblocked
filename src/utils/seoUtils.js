// 简化的SEO工具函数
const BASE_URL = 'https://geometry-dash-unblocked.com';
...
export const generatePageMetadata = ({
  ...
  description,
  path,
  ogImage = '/images/og-geometry-dash-unblocked.jpg'
}) => {
  const canonicalUrl = generateCanonicalUrl(path);
  const fullTitle = title.includes('Geometry Dash Unblocked') 
    ? title
  ...
  return {
    ...
    openGraph: {
      ...
      title: fullTitle,
      description,
      siteName: 'Geometry Dash Unblocked',
      images: [
        {
          url: ogImage,
          width: 1200,
