...
export const metadata = generatePageMetadata({
  title: 'About Us',
  description: 'Learn about Geometry Dash Unblocked, our mission to provide free online games, and our commitment to delivering the best gaming experience.',
  path: '/about',
});
    ...
    <Layout>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        <div className="text-left mb-6">
          ...
          <p className="text-base text-gray-600 dark:text-gray-300">Learn about Geometry Dash Unblocked's story and mission</p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow-sm p-4">
            ...
            <div className="prose prose-sm max-w-none text-left">
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">
                Geometry Dash Unblocked is a platform dedicated to providing free online games. We are committed to bringing 
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">
                Our platform features the classic Geometry Dash Unblocked game, an exciting rhythm-based action platformer that challenges 
          ...
          <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg p-4 text-white text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              ...
              <a
                href="mailto:support@geometry-dash-unblocked.com"
