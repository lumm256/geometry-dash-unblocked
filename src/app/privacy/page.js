...
export const metadata = generatePageMetadata({
  ...
  description: 'Our Privacy Policy explains how Geometry Dash Unblocked collects, uses, and protects your personal information when you use our gaming platform.',
  path: '/privacy',
});
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow-sm p-4">
            ...
            <div className="prose prose-sm max-w-none text-left">
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">
                Geometry Dash Unblocked ("we", "our", "the website") respects and protects the privacy rights of all visitors.
                This privacy policy explains how we collect, use, store, and protect your personal information.
              </p>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">
                By accessing and using our website <strong>geometry-dash-unblocked.com</strong>,
          ...
          <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg p-4 text-white text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <a
                href="mailto:support@geometry-dash-unblocked.com?subject=Privacy Policy Inquiry"
