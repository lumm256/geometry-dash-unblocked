...
export const metadata = generatePageMetadata({
  title: 'Contact Us',
  description: 'Get in touch with Geometry Dash Unblocked team. We\'d love to hear your feedback, suggestions, and help with any questions you may have.',
  path: '/contact',
});
        ...
        <div className="space-y-6">
              ...
              <div className="text-left">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    >
                      support@geometry-dash-unblocked.com
                    </a>
                  </div>
                </div>
              </div>
              <div className="text-left">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a 
                      href="https://geometry-dash-unblocked.com/"
                      className="text-blue-600 hover:text-blue-800 font-medium text-sm transition-colors"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      geometry-dash-unblocked.com
                    </a>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow-sm p-4">
            ...
            <div className="bg-gray-50 dark:bg-slate-700 rounded-lg p-4 text-center">
              ...
              <a
                href="mailto:support@geometry-dash-unblocked.com?subject=Website Inquiry&body=Hello,%0D%0A%0D%0AI would like to inquire about:%0D%0A%0D%0ADetailed description:%0D%0A%0D%0AThank you!"
