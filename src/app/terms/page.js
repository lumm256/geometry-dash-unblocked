...
export const metadata = generatePageMetadata({
  ...
  description: 'Read our Terms of Service to understand the rules and regulations for using Geometry Dash Unblocked platform and our free online games.',
  path: '/terms',
});
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow-sm p-4">
            ...
            <div className="prose prose-sm max-w-none text-left">
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">
                Welcome to Geometry Dash Unblocked ("our service", "website").
                This service is provided by <strong>geometry-dash-unblocked.com</strong>.
              </p>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow-sm p-4">
            ...
            <div className="space-y-3 text-left">
              <p className="text-sm text-gray-700 dark:text-gray-300">
                Geometry Dash Unblocked is a free online gaming platform that provides:
              </p>
          ...
          <div className="bg-gradient-to-r from-green-500 to-blue-600 rounded-lg p-4 text-white text-left">
            ...
            <a
              href="mailto:support@geometry-dash-unblocked.com?subject=Terms of Service Inquiry"
