...
export async function generateMetadata() {
  return generatePageMetadata({
    ...
    description: 'View the complete page structure of Geometry Dash Unblocked gaming website, including all games, categories and important page navigation links.',
    path: '/sitemap'
  });
}
