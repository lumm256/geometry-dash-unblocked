...
const _categories = {
  ...
  'guide': { name: 'Guides', color: 'bg-teal-500' },
  'geometry-dash': { name: 'Geometry Dash', color: 'bg-indigo-500' },
  'beginner': { name: 'Beginner', color: 'bg-cyan-500' },
  'parents': { name: 'Parents', color: 'bg-pink-500' },
  'strategy': { name: 'Strategy', color: 'bg-amber-500' },
};
const defaultCat = { name: 'General', color: 'bg-gray-500' };
const categories = new Proxy(_categories, { get: (t, p) => t[p] || defaultCat });
